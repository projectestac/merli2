...
<div class="esquerra">
	<div id="logo">
		<img id="img" src="../merli/web/imatges/logo.png" alt="MeRL�" title="MeRL�"/>
	</div>
	<div class="formulari">
		...
		<div class="content">		
				...
				<div class="opcional"><div class="option"><span class="left"><bean:message key="application.nodeform.thesaurus"/></span><span class="right"><a href="#" onclick="swapDisplay('formThesaure')">+</a></span></div></div>			
...
<div id="dreta">
	<div id="header">
		<div id="titleHeader">
			<div id="entorns">
				<a href="../gescur/gesNodes.do" title="Gestor Curricular">
					DUC
				</a>
				<span> | </span>
				<a href="../merli/usuaris.do" title="Gestor d'Usuaris">
					Magics
				</a>
				<span> | </span>
