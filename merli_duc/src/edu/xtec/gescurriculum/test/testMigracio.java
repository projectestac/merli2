...
import edu.xtec.gescurriculum.thesaurusMigracio.*;

public class testMigracio extends TestCase {

	public static void main(String[] args) {
		junit.swingui.TestRunner.run(testMigracio.class);
	}

	public final void testMigracio() throws Exception{
		ThesaurusLoad tl;
		/*
