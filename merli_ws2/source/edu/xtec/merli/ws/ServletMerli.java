...
public class ServletMerli extends ServletMain {
    ...
    /**
     * Processa el SOAPMessage, identifica de quin t�pus �s l'objecte enviat i
     * segons el t�pus executa la operaci� adequada. Retorna el missatge
     * retornat per la operaci� executada.
     */
...
/* END NADIM ADDED GET RESOURCE*/    
     ...
     *
     * Executa la operaci� setResource passant com a parametre el Lom.
     *
    ...
    private SOAPMessage setResource(SOAPElement sbeRequest, String ip) throws MerliDBException, SOAPException {
        ...
        if (comprovarIp(ip)) {
            ...
            logger.info("[SetResource] Adre�a no permesa -->" + ip);
            throw new SOAPException("Perm�s denegat");
        }
        return smResponse;
    }
     ...
     *
     * Executa la operaci� delResource passant com a parametre l'IdResource.
     *
     * Retorna un Result indicant la operaci� i que l'execuci� ha estat
     * correcte.
     *
    ...
    public SOAPMessage delResource(SOAPElement sbeRequest, String ip) throws SOAPException, MerliDBException {
        ...
        if (comprovarIp(ip)) {
            ...
            logger.info("[DelResource] Adre�a no permesa -->" + ip);
            throw new SOAPException("Perm�s denegat");
        }
     ...
     * adequat dins el domini. En aquest cas un IdResource.
     *
     * Executa la operaci� unpublishRecurs passant com a parametre l'IdResource.
     *
     * Retorna un Result indicant la operaci� i que l'execuci� ha estat
     * correcte.
     *
...
//		smResponse= internalError(new MerliDBException(MerliDBException.OBJECTE_INEXISTENT),UNPUBLISHRESOURCE);
     ...
     * adequat dins el domini. En aquest cas un Lom
     *
     * Executa la operaci� addResource passant com a parametre el Lom.
     *
     * Retorna un Result indicant la operaci� i que l'execuci� ha estat correcte
    ...
    public SOAPMessage addResource(SOAPElement sbeRequest, String ip) throws SOAPException, MerliDBException {
        ...
        if (comprovarIp(ip)) {
            ...
            logger.info("[AddResource] Adre�a no permesa -->" + ip);
            throw new SOAPException("Perm�s denegat");
        }
     ...
     * adequat dins el domini. En aquest cas un IdResource.
     *
     * Executa la operaci� getResource passant com a parametre l'IdResource. Se
    ...
    public SOAPMessage getResource(SOAPElement sbRequest/*,SOAPBodyElement sbLomes*/) throws SOAPException, MerliDBException {
        ...
        //Es passa el valor de l'atribut lomEs. Per defecte �s "false".
    ...
    public SOAPMessage editResource(SOAPElement sbeRequest, String ip) throws SOAPException, MerliDBException {
        ...
        if (comprovarIp(ip)) {
            ...
            logger.info("[EditResource] Adre�a no permesa -->" + ip);
            throw new SOAPException("Perm�s denegat");
        }
        return smResponse;
    }
