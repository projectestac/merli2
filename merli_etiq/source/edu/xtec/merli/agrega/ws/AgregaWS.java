...
public class AgregaWS {      
	...
	public static final int SOLICITARENTREGARSESSION = 023;
	
	public static final int CREARSESION = 		031;
	public static final int DESTROYSESSION = 	032;
	public static final int CREARANONYMOUSSESION = 033;
	...
	public static final int INTEGRACIO = 		205;
	...
	/**
 	 ...
 	 public SOAPElement processOperation(int idOperation, ObjectMerli objm, int server)
     {
		...
		switch (idOperation){
			case GETRESOURCE:
				smRequest = AgregaMerliWS.processGetResource((IdResource) objm, smRequest, mf, sf);
