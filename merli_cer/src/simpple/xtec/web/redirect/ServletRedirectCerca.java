 ...
 */
public class ServletRedirectCerca extends HttpServlet 
{    

	 // logger
	 static final Logger logger = Logger.getLogger(simpple.xtec.web.redirect.ServletRedirectCerca.class);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
                   throws IOException {
    	try {
    	  response.sendRedirect("cerca/cercaSimple.jsp");	
    	 } catch (Exception e) {
    	 logger.error(e);	
    	 }
    }
