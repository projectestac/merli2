...
var getFunctionsUrl = "http://localhost:8080/CercadorEducacio/ServletAutocompletion?s=";
...
{  
  ...
  else
  {
    ...
    {  
      ...
      div += "<tr id='tr" + i + 
             "' onclick='' onmouseover='handleOnMouseOver(this);' " + 
             "onmouseout='handleOnMouseOut(this);'>" + 
             "<td align='left'><a id='a" + i + 
             "' href='javascript:updateKeyword();";
