...
%>
  <ul>
    ...
    <li id="current"><a href="<%=urlLocal%>/<%=contextWeb%>/complet/fragments.jsp">Cercador avançat professorat</a></li>
    </ul>
    ...
    <td>
		<table class="tableMenuEsq" cellpadding="0" border="0">
		  ...
		  <tr class="menuEsqNivell2">
		      ...
		      <td>&nbsp;&nbsp;&nbsp;<a href="<%=urlCercador%>/<%=contextWeb%>/complet/fragments.jsp">Configuració resultats</a></td>
		  </tr>
		  <tr class="menuEsqNivell3">
		      <td>&nbsp;&nbsp;&nbsp;<a href="<%=urlCercador%>/<%=contextWeb%>/complet/pesos.jsp">Pesos</a></td>
		  </tr>
		  <tr class="menuEsqNivell2">
		      <td>Logs</td>
		  </tr>
		  <tr class="menuEsqNivell3">
		      <td>&nbsp;&nbsp;&nbsp;<a href="<%=urlCercador%>/<%=contextWeb%>/complet/logs.jsp">Logs</a></td>
		  </tr>		  
