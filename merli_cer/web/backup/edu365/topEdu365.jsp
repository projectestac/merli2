...
%>
  <ul>
    ...
    <li id="current"><a href="<%=urlCercador%>/<%=contextWeb%>/edu365/fragments.jsp">edu365</a></li>
    ...
    <td>
		<table class="tableMenuEsq" cellpadding="0" border="0">
		  ...
		  <tr class="menuEsqNivell2">
		      ...
		      <td>&nbsp;&nbsp;&nbsp;<a href="<%=urlCercador%>/<%=contextWeb%>/edu365/fragments.jsp">Configuració resultats</a></td>
		  </tr>
		  <tr class="menuEsqNivell3">
		      <td>&nbsp;&nbsp;&nbsp;<a href="<%=urlCercador%>/<%=contextWeb%>/edu365/pesos.jsp">Pesos</a></td>
		  </tr>
		  <tr class="menuEsqNivell2">
		      <td>Logs</td>
		  </tr>
		  <tr class="menuEsqNivell3">
		      <td>&nbsp;&nbsp;&nbsp;<a href="<%=urlCercador%>/<%=contextWeb%>/edu365/logs.jsp">Logs</a></td>
		  </tr>		  
