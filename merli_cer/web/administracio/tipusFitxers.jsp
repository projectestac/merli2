...
<%
    ...
    Logger logger = Logger.getLogger("tipusFitxers.jsp");
...
<div id="content">
    <form name="editarTipusFitxers" method="POST" action="/<%=Configuracio.contextWebAplicacio%>/administracio/editarTipusFitxers.jsp">
    ...
    <form name="tipusFitxers" method="POST" action="/<%=Configuracio.contextWebAplicacio%>/ManagerTipusFitxers">
        ...
        <fieldset>
            ...
            <div id="linia">
                ...
                <input type="text" name="nouGrup" id="nouGrup" value=""/><br/>
                ...
                <textarea name="mimeType" id="mimeType" value="" cols="40"></textarea><br/>
                <input type="submit" value="<%=XMLCollection.getProperty("administracio.tipusFitxers.Afegir")%>" name="<%=XMLCollection.getProperty("administracio.tipusFitxers.Afegir")%>"/>
            </div>
        </fieldset>     
    </form>
    <br/>
